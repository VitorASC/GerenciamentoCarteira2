...
export default function ContaPanel({ onUserUpdated }) {
	...
	return <div className="entity-page account-page">
		...
		<section className="dashboard-card entity-list-card account-users"><header className="entity-card-head"><div><h3>Usuários cadastrados</h3><p>Consulta secundária para identificação e demonstração dos registros.</p></div><span>{formatNumber(users.length)} usuários</span></header>
